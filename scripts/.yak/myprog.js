...
(function () {
  ...
  function embedVideo() {
    ...
    var _firstScriptTag = document.body.appendChild(tag);
  ...
  //<iframe width="560" height="315" src="//www.youtube.com/embed/3KL9mRus19o?autoplay=1" frameborder="0" allowfullscreen></iframe>
  ...
  function setupAnimations() {
    ...
    for (var i = 0; i <= numKeyFrames; i++) {
      ...
      var _x = (Math.random() - 0.5) * jitterAmount;
      var _y = (Math.random() - 0.5) * jitterAmount;
      x = ~~x;
      y = ~~y;
      var _keyframe = "-webkit-transform: translate(" + x + "px," + y + "px); ";
